...
//                 <h1 className="text-4xl font-bold mb-4">About Deepfake Detector</h1>
//                 <p className="max-w-2xl text-center text-lg text-gray-700">
//                     This web app allows users to upload images or videos and checks whether they are deepfakes using a pretrained AI model.
//                     The model evaluates the content and returns a confidence score and prediction.
//                 </p>
//                 <Link to="/" className="mt-6 text-blue-600 hover:underline">← Back to Home</Link>
//             </div>
//         </>
//     );
// };
