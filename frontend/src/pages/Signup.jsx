            ...
            <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
                ...
                <form className="mt-6">
                    <div className="mb-4">
                        ...
                        <input type="text" className="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter your full name" />
                    </div>
                    <div className="mb-4">
                    ...
                    <div className="mb-4">
                        ...
                        <input type="password" className="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Create a password" />
                    </div>
